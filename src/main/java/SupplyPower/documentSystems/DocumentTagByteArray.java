...
public class DocumentTagByteArray extends DocumentBasePrimitiveArray {
    ...
    protected DocumentTagByteArray() {
    }
        ...
        for (int len = 0; len < nodeList.getLength(); ++len) {
            ...
            for (int len1 = 0; len1 < length; ++len1) {
                ...
                if (node1 instanceof Element && node1.getNodeName().equals(this.entryName + String.valueOf(len1)))
                    this.data[len1] = Byte.parseByte(node1.getTextContent());
            }
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentTagByteArray)) return false;

        return Arrays.equals(this.data, ((DocumentTagByteArray) o).data);
    }
