...
public class VirtualException extends Exception {
    ...
    public VirtualException(Class<? extends Exception> classException) {
        this(classException.getPackage().getName(), classException.getName(), classException.getModifiers(), new Class[]{}, new Object[]{}, new Class[]{});
    }

    public VirtualException(Class<? extends Exception> classException, String message) {
    ...
    public VirtualException(Class<? extends Exception> classException, String message, Throwable throwable) {
    ...
    public VirtualException(Class<? extends Exception> classException, Throwable throwable) {
    ...
    public VirtualException(String virtualPackageName, String virtualClassName, int constructorModifier, Class[] constructorClasses, Object[] constructorObjects, Class<? extends Exception>... constructorExceptions) {
