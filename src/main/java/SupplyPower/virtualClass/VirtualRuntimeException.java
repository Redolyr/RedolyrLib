 ...
 */
public class VirtualRuntimeException extends RuntimeException {
    ...
    public VirtualRuntimeException(Class<? extends Exception> classException) {
        this(classException.getPackage().getName(), classException.getName(), classException.getModifiers(), new Class[]{}, new Object[]{}, new Class[]{});
    }

    public VirtualRuntimeException(Class<? extends Exception> classException, String message) {
    ...
    public VirtualRuntimeException(Class<? extends Exception> classException, String message, Throwable throwable) {
    ...
    public VirtualRuntimeException(Class<? extends Exception> classException, Throwable throwable) {
    ...
    public VirtualRuntimeException(String virtualPackageName, String virtualClassName, int constructorModifier, Class[] constructorClasses, Object[] constructorObjects, Class<? extends Exception>... constructorExceptions) {
    ...
    private Object update() throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, ClassNotFoundException, InstantiationException {
