...
public class ElementTagFloatArray extends ElementBasePrimitiveArray
{
	private float[] data;
	ElementTagFloatArray() {}
	public ElementTagFloatArray(float[] par1)
	{
		this.data = par1;
	}
	...
	public String toString()
	{
		...
		for (int len = 0; len < toFloatArray().length; len++) tsb.append(toFloatArray()[len]).append(len != toFloatArray().length - 1 ? ", " : "");
		return "[" + tsb + "]";
	}
}
