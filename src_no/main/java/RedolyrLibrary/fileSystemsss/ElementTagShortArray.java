...
public class ElementTagShortArray extends ElementBasePrimitiveArray
{
	private short[] data;
	ElementTagShortArray() {}
	public ElementTagShortArray(short[] par1)
	{
		this.data = par1;
	}
